        ...
        <div class="hidden md:flex md:flex-col w-64 bg-white shadow-lg">
            ...
            <div class="p-4 border-b border-gray-100">
                <div class="flex items-center space-x-3">
                    <div class="relative">
                        <img src="https://m.media-amazon.com/images/M/MV5BZDcyMGU3MDEtODkwOS00ZGFlLTllNTAtMGExMDE3OTAzMjI5XkEyXkFqcGc@._V1_.jpg" alt="{{ auth()->user()->name }}" class="w-10 h-10 rounded-full object-cover border-2 border-indigo-100">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="relative">
                            <button class="flex items-center space-x-2 hover:bg-gray-50 p-1 rounded-full focus:outline-none">
                                <div class="relative">
                                    <img src="https://m.media-amazon.com/images/M/MV5BZDcyMGU3MDEtODkwOS00ZGFlLTllNTAtMGExMDE3OTAzMjI5XkEyXkFqcGc@._V1_.jpg" alt="{{ auth()->user()->name }}" class="w-8 h-8 rounded-full object-cover">
                                </div>
                                    ...
                                    <div class="flex flex-col md:flex-row md:items-center">
                                        ...
                                        <div class="flex md:flex-col items-center justify-end p-4 md:p-5 bg-gray-50 border-t md:border-t-0 md:border-l border-gray-100">
                                            <div class="flex flex-row md:flex-col space-x-3 md:space-x-0 md:space-y-3">
                                                ...
                                                <!-- Edit button -->
                                                <a href="/tasks/{{ $task->id }}/edit" class="p-2 bg-indigo-100 text-indigo-700 rounded-full hover:bg-indigo-200 transition-colors">
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
