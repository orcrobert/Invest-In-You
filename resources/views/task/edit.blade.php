                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input type="text" name="title" id="title"
                                    ...
                                    placeholder="Wash the dishes" value="{{ $task->title }}" required>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input type="date" name="deadline" id="deadline"
                                    class="block w-full border-0 py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6" value="{{ $task->dealine }}">
                            </div>
                        </div>
                    </div>
                </div>
